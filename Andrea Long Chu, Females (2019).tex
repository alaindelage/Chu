...
\begin{center}
	\emph{RUSSELL. You don’t know what a female is, you desexed monstrosity.}
\end{center}
...
\begin{center}
	\emph{MISS COLLINS. I face reality, and our reality is that we’re men.}
\end{center}
...
\begin{center}
	\emph{BONGI. Why’re girls called chicks? After all, men have the peckers.}
\end{center}
...
\begin{quote}
	Pornography is what it feels like when you think you have an object, but really the object has \emph{you}. It is therefore a quintessential expression of femaleness.
\end{quote}
\vskip 2ex
...
\begin{quote}
	...
	Neither of them, we are asked to believe, are female.
\end{quote}
\vskip 3ex
...
transsexuality’s long history of being considered a paraphilia\par
...
\begin{center}
	\emph{BONGI. Let the guys ram each other inthe ass and leave the women alone.}
\end{center}
